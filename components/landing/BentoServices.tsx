...
function BentoCard({
  ...
  return (
    <motion.div
      whileHover={{ y: -5 }}
      whileTap={{ scale: 0.98 }}
      className="group bg-card border-border/50 hover:shadow-primary/10 relative flex h-full w-full cursor-pointer flex-col justify-between overflow-hidden rounded-3xl border p-6 transition-shadow duration-500 hover:shadow-2xl"
    >
