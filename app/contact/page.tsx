    ...
    <Box sx={{ py: { xs: 6, md: 12 } }}>
      <Container maxWidth="lg">
        <Box sx={{ textAlign: "center", mb: { xs: 6, md: 10 } }}>
          ...
          >
            [INSERT CONTACT INTRODUCTION HERE] Ready to secure your financial future? Schedule a
          ...
          <Grid item xs={12} md={6}>
            <Card>
              <Card.Content>
                ...
                >
                  [INSERT CALENDAR DESCRIPTION HERE] Book a time that works for you. We'll discuss
                  your financial goals and create a personalized plan.
                </Typography>
                <Box
                  sx={{
                    width: "100%",
